      ...
      <div className="flex items-center justify-between border-b px-5 py-4">
        <div>
          ...
          <p className="text-xs text-muted-foreground">
            Outstanding invoices requiring customer payment follow-up
          </p>
        </div>
        <Link
          ...
          <table className="w-full text-left text-xs">
            <thead className="border-b bg-muted/40 font-semibold text-muted-foreground uppercase tracking-wider">
              <tr>
                ...
                <th className="px-5 py-3 text-right">Outstanding Amount</th>
              ...
              {items.map((invoice) => (
                <tr key={invoice.id} className="hover:bg-muted/30 transition-colors">
                  ...
                  <td className="px-5 py-3.5 text-muted-foreground">
                    {formatDate(invoice.dueDate, 'No due date')}
                  </td>
                </tr>
              ))}
            </tbody>
